    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link  {{ request()->routeIs('manager.home') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('manager.users') ? 'active' : '' }}" href="{{ route('manager.users') }}">
                        <span class="nav-icon"><i class="bi bi-people"></i></span>
                        <span class="nav-text">إدارة المستخدمين</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('manager.completed-trips') ? 'active' : '' }}"  href="{{ route('manager.completed-trips') }}">
