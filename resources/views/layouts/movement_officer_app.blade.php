    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <span class="sidebar-user-role">مسؤول حركة</span>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link  {{ request()->routeIs('movement_officer.home') ? 'active' : '' }}"
                        href="{{ route('movement_officer.home') }}">
                        <span class="nav-icon"><i class="bi bi-speedometer2"></i></span>
                        <span class="nav-text">المراقبة المباشرة</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  {{ request()->routeIs('movement_officer.completed-trips') ? 'active' : '' }}"
                        href="{{ route('movement_officer.completed-trips') }}">
                        <span class="nav-icon"><i class="bi bi-check2-all"></i></span>
                        <span class="nav-text">مراجعة المكتملة</span>
                    </a>
                </li>
            </ul>
        </nav>
