       ...
       <div class="sidebar-brand">
        ...
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <span class="sidebar-user-role">مسؤول تذاكر </span>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link  {{ request()->routeIs('ticket-officer.home') ? 'active' : '' }}"
                        href="{{ route('ticket-officer.home') }}">
                        <span class="nav-icon"><i class="bi bi-speedometer2"></i></span>
                        <span class="nav-text">الرحلات الحالية</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('ticket-officer.completed-trips') ? 'active' : '' }}"
                        href="{{ route('ticket-officer.completed-trips') }}">
                        <span class="nav-icon"><i class="bi bi-people"></i></span>
                        <span class="nav-text">الرحلات المكتملة</span>
                    </a>
                </li>
