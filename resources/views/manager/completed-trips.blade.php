@extends('layouts.manager_app') {{-- أو التخطيط الخاص بك --}}
...
<div class="main-content">
        ...
        <div class="row">
            @forelse ($months as $m)
                <div class="col-md-4 col-lg-3 mb-4">
                    <a href="{{ route('manager.completed-trips', ['month' => $m['ym']]) }}" class="text-decoration-none">
    ...
    @else
        <div class="top-header">
            ...
            <a href="{{ route('manager.completed-trips') }}" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-arrow-right"></i> رجوع للأرشيف
            </a>
        </div>

        <form action="{{ route('manager.completed-trips') }}" method="GET" class="row g-2 mb-3">
            ...
            @if ($q !== '')
                <div class="col-md-2">
                    <a href="{{ route('manager.completed-trips', ['month' => $month]) }}" class="btn btn-outline-secondary w-100">إلغاء الفلترة</a>
                </div>
            @endif
        </form>
